...
const Book = () => {
    return (
        <div
            className="w-full md:h-[888px] bg-cover mb-12"
        ...
        >
            <div className="py-32 max-w-screen-2xl mx-auto px-12">
                ...
                <div className="space-y-8">
                    <h1 className="font-bebas text-[60px] md:text-[62px] font-bold leading-[62px]  decoration-solid decoration-transparent decoration-skip-ink text-white">Book Your Table</h1>
                        ...
                        <form className="pb-8">
                            <div className='flex md:flex-row flex-col  gap-6'>
                                <input
                                    type="text"
                                    name="name"
                                    className="md:w-[420px] h-[52px] text-white mb-4 border border-white bg-black  p-2 placeholder-white"
                            ...
                            <textarea
                                type="text"
                                name="text"
                                className="md:w-[420px] w-full  text-white mb-4 border border-white bg-black  p-2 placeholder-white"
                                placeholder="Message"
                                rows={8}
                                required
                            />

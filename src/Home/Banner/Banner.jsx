...
const Banner = () => {
    return (
        <div
            className="w-full h-full lg:pt-12 md:pt-40 pt-0 md:pb-40 pb-7 z-5"
            style={{
                background: 'linear-gradient(123.4deg, #BD1F17 40.8%, #A61D13 76.4%, #8E1B0F 120.69%)',
            }}
        >
            <div className='max-w-screen-2xl mx-auto relative px-9 lg:px-0 md:px-0'>
                <div className="flex flex-col md:flex-col lg:flex-row justify-between gap-10 md:gap-32 items-center pt-12">
                    <div className="space-y-8 md:space-y-16">
                        <h1
                            ...
                            className="absolute text-[46px] lg:text-start md:text-center sm:text-[60px] md:text-[80px] lg:text-[100px] font-bold text-white uppercase leading-tight md:leading-[90px] lg:leading-[110px] py-3 md:py-5 pr-4 md:pr-12"
                        >
                    ...
                    <div className="flex justify-center md:justify-end">
                        <img className="w-full sm:w-[500px] md:w-[600px] lg:w-[700px] " src={banner} alt="Saudi cuisine banner" />
